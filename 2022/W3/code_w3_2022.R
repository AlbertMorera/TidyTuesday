...
ggplot() +
  ...
  labs(title = "Tracking cocoa beans of the real BLACK chocolate",
       subtitle = "From which countries do the cocoa beans used to make 100% cocoa chocolate come from? And where is it manufactured afterwards?",
...
ggsave("2022/W3/chocolate_2.png", width = 15, height = 9.12, units = "cm", dpi = 1000)
